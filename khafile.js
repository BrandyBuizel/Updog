...
project.addShaders('build_updog/compiled/Shaders//armdefault_mesh.frag.glsl');
project.addShaders('build_updog/compiled/Shaders//armdefault_mesh.vert.glsl');
project.addShaders('build_updog/compiled/Shaders//armdefault_shadowmap.vert.glsl');
project.addAssets("build_updog/compiled/Shaders/Material_002_data.arm", { notinlist: true });
project.addAssets("build_updog/compiled/Shaders/armdefault_data.arm", { notinlist: true });
